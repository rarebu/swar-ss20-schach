...
import de.htwg.se.Schach.model.fieldComponent.fieldBaseImpl.rules.PawnPromotion
import de.htwg.se.Schach.model.fieldComponent.fieldBaseImpl.{Bishop, Cell, Colour, Coordinates, Field, Matrix, Pawn, RemovedFigures}
